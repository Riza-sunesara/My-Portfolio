    ...
    <>
      <div className="flex mt-7 justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
        <form
          ...
          className="w-[100%] px-5 md:w-[600px]"
        >
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="font-semibold text-center leading-7 text-gray-900 text-3xl">
                ADD NEW PROJECT
              </h2>
                    ...
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Artificial Intelligence Models">ARTIFICIAL INTELLIGENCE MODELS</SelectItem>
                          <SelectItem value="Machine Learning Models">MACHINE LEARNING MODELS</SelectItem>
                          <SelectItem value="Excel">MS EXCEL</SelectItem>
